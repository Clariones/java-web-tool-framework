...
public class Order implements  java.io.Serializable{
	...
	protected		List<LineItem> mCommerceItemList;
	...
	public 	Order(String	id,BuyerCompany	buyer,SellerCompany	seller,String	title,double	total_amount,String	type,int	version)
	{
		...
		this.mCommerceItemList = new ArrayList<LineItem>();	
	}
	...
	public  List<LineItem> getCommerceItemList(){
		if(this.mCommerceItemList == null){
			this.mCommerceItemList = new ArrayList<LineItem>();
		}
		return this.mCommerceItemList;	
	}
	public  void setCommerceItemList(List<LineItem> CommerceItems){
		this.mCommerceItemList=CommerceItems;
		
	}
	
	public  void addCommerceItem(LineItem commerce_item){
		getCommerceItemList().add(commerce_item);
	}
	public  void addCommerceItems(List<LineItem> commerce_items){
		getCommerceItemList().addAll(commerce_items);
	}
	
	public  void removeCommerceItem(LineItem commerce_item){
		getCommerceItemList().remove(commerce_item);
	}
